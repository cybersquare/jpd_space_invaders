...
# Login panel
panel_login = pygame_gui.elements.ui_panel.UIPanel(pygame.Rect((150, 100), (550, 450)), 
...
txt_high_scores=pygame_gui.elements.ui_text_box.UITextBox(relative_rect=pygame.Rect((10, 220), (525, 200)), 
